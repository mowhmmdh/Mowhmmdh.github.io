...
for path, block in [(ROOT/'blog/index.html', BLOCK_FA), (ROOT/'en-blog.html', BLOCK_EN)]:
    ...
    if 'content-theme-2026.css' not in text and '</head>' in text:
        text = text.replace('</head>', '<link rel="stylesheet" href="/assets/content-theme-2026.css">\n</head>', 1)
