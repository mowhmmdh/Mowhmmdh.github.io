...
:where(.site-nav,.navbar,.nav,.header-nav,.vt-nav,.mh-nav){background:var(--mha-surface)!important;color:var(--mha-text)!important;border-color:var(--mha-line)!important}\\n\
:where(.card,.post-card,.project-card,.service-card,.about-card,.feature-card,.timeline-item,.skill-category,.faq-item,.contact-wrapper,.metric,.stat,.profile-card,.panel,.feature,.case-card,.case-study,.service,.vt-card,.vt-panel,.mh-card,.mh-expertise,.mh-identity-card){background:var(--mha-surface)!important;color:var(--mha-text)!important;border-color:var(--mha-line)!important}\\n\
:where(.nav a,.navbar a,.header-nav a,.site-nav a,.mh-nav a){color:var(--mha-muted)!important}\\n\
:where(.nav a:hover,.navbar a:hover,.header-nav a:hover,.site-nav a:hover,.mh-nav a:hover){color:var(--mha-accent-strong)!important}\\n\
:where(p,li,dd,dt,small,.muted,.sub,.subtitle,.description,.lead,.hero-subtitle,.card p,.post-card p,.meta,.meta span,.mh-lead,.mh-section-lead){color:var(--mha-muted)}\\n\
:where(h1,h2,h3,h4,h5,h6){color:var(--mha-text)}\\n\
:where(input,textarea,select){background:var(--mha-surface)!important;color:var(--mha-text)!important;border-color:var(--mha-line)!important}\\n\
:where(input,textarea,select)::placeholder{color:var(--mha-muted)!important}\\n\
:where(.theme-toggle,.mobile-menu){background:var(--mha-surface)!important;color:var(--mha-text)!important;border-color:var(--mha-line)!important}\\n\
:where(.theme-toggle:hover,.mobile-menu:hover){background:var(--mha-surface-2)!important;border-color:var(--mha-accent)!important}\\n\
:where(.mh-eyebrow,.mh-kicker,.eyebrow,.kicker,.section-tag,.tag,.vt-kicker){color:var(--mha-accent-strong)!important}\\n\
html[data-theme="light"] :where(.terminal,.mh-terminal,pre){background:#111923!important;color:#dbe4ec!important}\\n\
html[data-theme="light"] :where(.btn.primary,.btn-primary,.vt-btn.primary,.mh-btn-primary){background:var(--mha-accent)!important;color:#fff!important;border-color:var(--mha-accent)!important}\\n\
html[data-theme="dark"] :where(.btn.primary,.btn-primary,.vt-btn.primary,.mh-btn-primary){background:linear-gradient(135deg,#d2a84e,#f0c85a)!important;color:#10151a!important;border-color:#d2a84e!important}\\n\
:where(.card,.post-card,.project-card,.service-card,.about-card,.feature-card,.case-card,.case-study,.service,.vt-card,.vt-panel,.mh-card,.mh-expertise){transition:transform .22s cubic-bezier(.2,.7,.2,1),box-shadow .22s ease,border-color .22s ease!important}\\n\
html.mha-theme-switching *{transition:none!important;animation:none!important}\\n\
